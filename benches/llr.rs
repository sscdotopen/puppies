...
#[inline(always)]
pub fn llr_cse(k11: u64, k12: u64, k21: u64, k22: u64) -> f64 {
...
#[inline(always)]
pub fn llr_no_cse(k11: u64, k12: u64, k21: u64, k22: u64) -> f64 {
...
fn bench_llr_cse(bench: &mut Bencher) {
  ...
  let mut rng = rand::XorShiftRng::from_seed(FIXED_SEED);

  bench.iter(|| {
    for _ in 0..NUM_REPETITIONS {
      llr_cse(rng.next_u32() as u64, rng.next_u32() as u64, rng.next_u32() as u64,
              rng.next_u32() as u64);
    }
  })
}
...
fn bench_llr_no_cse(bench: &mut Bencher) {
  ...
  bench.iter(|| {
    for _ in 0..NUM_REPETITIONS {
      llr_no_cse(rng.next_u32() as u64, rng.next_u32() as u64, rng.next_u32() as u64,
                 rng.next_u32() as u64);
    }
  })
}
